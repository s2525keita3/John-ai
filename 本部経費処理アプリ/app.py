...
# メインの「取引データ」「支給控除」アップロード枠を大きく見やすく（照合 expander 内は別 CSS）
...
[data-testid="stMain"] [data-testid="stVerticalBlockBorderWrapper"] [data-testid="stFileUploader"] {
    width: 100% !important;
}
[data-testid="stMain"] [data-testid="stVerticalBlockBorderWrapper"] [data-testid="stFileUploader"] section {
...
st.markdown(HONBU_MAIN_UPLOAD_DROPZONE_CSS, unsafe_allow_html=True)
